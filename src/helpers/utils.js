...
import { nonKitchenItems } from '../objects/meta';
...
export const isDrink = (catName) => {
    if (!catName) return false;
    return nonKitchenItems.some(ite => catName.toLowerCase().includes(ite)) || catName.toLowerCase().includes('drink') || catName.toLowerCase().includes('beverage');
}
